...
def main():
    ...
    region_env = os.environ.get('AWS_DEFAULT_REGION', 'eu-central-1')
    dry_run = os.environ.get('dry_run', 'yes')

    account = os.environ.get('account', 'perf')
    ...
    es_index = os.environ.get('es_index', 'cloud-governance-ec2-index')
