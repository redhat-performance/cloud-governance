...
def test_verify_and_delete_resource_not_stopped():
    ...
    resource = ec2_client.allocate_address(Domain='vpc', TagSpecifications=[{'ResourceType': 'elastic-ip', 'Tags': tags}])
    ...
    assert len(ec2_client.describe_addresses()['Addresses']) == 1
...
def test_verify_and_delete_resource_stopped():
    ...
    resource = ec2_client.allocate_address(Domain='vpc',
