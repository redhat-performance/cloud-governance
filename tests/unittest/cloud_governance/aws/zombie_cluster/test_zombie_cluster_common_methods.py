...
def test_trigger_mail_routes_to_lowercase_email_tag_key():
    """
    This method tests a manually-added lowercase 'email' tag key is honored, not silently
    dropped - zombie_cluster_common_methods previously did an exact-case tag-key match.
    """
    environment_variables.environment_variables_dict['ALLOWED_EMAIL_DOMAINS'] = ['@redhat.com']
    zcm = _make_instance()
    zcm._mail = MagicMock()
