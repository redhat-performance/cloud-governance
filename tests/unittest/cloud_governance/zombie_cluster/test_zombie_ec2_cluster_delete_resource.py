...
def test_delete_ec2_elastic_load_balancer():
    ...
    assert not EC2_Resources().find_load_balancer(elb_name='test-load-balancer')
...
def test_delete_ec2_elastic_load_balancer_v2():
    ...
    assert not EC2_Resources().find_load_balancer_v2(elb_name='test-load-balancer-v2')
...
def test_delete_ebs_volume():
    ...
    assert EC2_Resources().find_volume()
...
def test_delete_snapshots():
    ...
    assert not EC2_Resources().find_snapshots(snapshots['SnapshotId'])
...
def test_delete_ec2_vpc_endpoints():
    ...
    assert EC2_Resources().find_vpc_endpoints(vpc_endpoint_id)
...
def test_delete_security_group():
    ...
    assert not EC2_Resources().find_security_group(sg1)
...
def test_delete_nat_gateway():
    ...
    assert EC2_Resources().find_nat_gateway(nat_gateway_id)
...
def test_delete_network_acl():
    ...
    assert not EC2_Resources().find_network_acl(network_acl_id)
...
def test_delete_network_interface():
    ...
    assert EC2_Resources().find_network_interface(network_interface_id)
...
def test_delete_internet_gateway():
    ...
    assert not EC2_Resources().find_internet_gateway(ing_id)
...
def test_delete_subnet():
    ...
    assert not EC2_Resources().find_subnet(subnet1)
...
def test_delete_elastic_ip():
    ...
    assert EC2_Resources().find_elastic_ip()
