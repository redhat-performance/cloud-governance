...
def test_delete_ec2_vpc_endpoints():
    ...
    assert not EC2Operations().find_vpc_endpoints(vpc_endpoint_id)
...
def test_delete_dhcp_option_set():
    ...
    assert not EC2Operations().find_dhcp_options(dhcp_id=dhcp['DhcpOptions']['DhcpOptionsId'])
...
def test_delete_nat_gateway():
    ...
    assert not EC2Operations().find_nat_gateway(nat_gateway_id)
...
def test_delete_network_interface():
    ...
    assert not EC2Operations().find_network_interface(network_interface_id)
