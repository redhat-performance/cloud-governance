...
# policy=tag_iam_user
sudo podman run --rm --name cloud-governance -e policy=tag_iam_user -e resource_name=read -v ${pwd}/user:/usr/local/cloud_governance/main/user -e log_level=INFO quay.io/ebattat/cloud-governance
